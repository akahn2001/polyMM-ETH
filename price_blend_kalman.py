...
class PriceBlendKalman:
    ...
    def __init__(
        ...
        binance_meas_var: float = 12.0**2,  # 3x trust in RTDS vs Binance (was 6x with 5.0**2)
    ...
    def update_rtds(self, z_rtds: float):
        ...
        if self.rtds_observation_count > 10:  # Wait for convergence
            ...
            should_learn_bias = not self.pause_bias_learning_during_movement or time_since_change > 5.0
