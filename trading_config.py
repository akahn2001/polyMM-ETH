...
AGGRESSIVE_MAX_TOTAL_ADJUSTMENT = 0.040  # 4¢ cap when aggressive (crosses spread by 1+ tick)
AGGRESSIVE_MAX_Z_SCORE_SKEW = 0.050     # Allow 4.5¢ z_skew in aggressive mode (vs 3.5¢ normal)
