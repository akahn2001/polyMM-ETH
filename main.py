...
async def main():
    ...
    global_state.all_tokens = ["111473506652285055782133225105987824268713124266611803095479363291007725115627"]
    ...
    global_state.price_blend_filter = PriceBlendKalman(
        ...
        rtds_meas_var=2.0**2,
        binance_meas_var=4.0**2,  # Lower noise = higher weight on Binance = faster response
